...
- The remediation sidebar now includes an expanded **Why this finding matters** principles panel. It shows each applicable principle with its readable label, canonical doctrine name, and finding-specific evidence before approval, keeping the active review flow explicitly principles-based.
